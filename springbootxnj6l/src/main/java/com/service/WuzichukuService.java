...
public interface WuzichukuService extends IService<WuzichukuEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<WuzichukuEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<WuzichukuEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<WuzichukuEntity> wrapper);
}

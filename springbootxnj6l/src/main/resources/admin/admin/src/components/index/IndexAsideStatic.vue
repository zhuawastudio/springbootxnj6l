      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(41, 142, 71, 1)"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = " linear-gradient(120deg, rgba(41, 142, 71, 0.8)10%, rgba(41, 142, 71, 1)100%)"
...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: linear-gradient(to right, rgba(41, 142, 71,0.7) 0%, rgba(41, 142, 71,0.8) 50%, rgba(41, 142, 71,1) 100%) !important;

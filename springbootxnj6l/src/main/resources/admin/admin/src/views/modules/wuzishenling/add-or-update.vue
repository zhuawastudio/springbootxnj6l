<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="申领单号" prop="shenlingdanhao">
            <el-input v-model="ruleForm.shenlingdanhao" 
                placeholder="申领单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shenlingdanhao" label="申领单号" prop="shenlingdanhao">
              <el-input v-model="ruleForm.shenlingdanhao" 
                placeholder="申领单号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申领数量" prop="shenlingshuliang">
          <el-input v-model="ruleForm.shenlingshuliang" 
              placeholder="申领数量" clearable  :readonly="ro.shenlingshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申领数量" prop="shenlingshuliang">
              <el-input v-model="ruleForm.shenlingshuliang" 
                placeholder="申领数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="申领日期" prop="shenlingriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.shenlingriqi" 
                type="date"
                :readonly="ro.shenlingriqi"
                placeholder="申领日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shenlingriqi" label="申领日期" prop="shenlingriqi">
              <el-input v-model="ruleForm.shenlingriqi" 
                placeholder="申领日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="申领说明" prop="shenlingshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="申领说明"
                  v-model="ruleForm.shenlingshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shenlingshuoming" label="申领说明" prop="shenlingshuoming">
                    <span>{{ruleForm.shenlingshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	shenlingdanhao : false,
	wuzimingcheng : false,
	wuzifenlei : false,
	wuzitupian : false,
	wuzishuliang : false,
	shenlingshuliang : false,
	shenlingshuoming : false,
	shenlingriqi : false,
	yonghuming : false,
	xingming : false,
	shouji : false,
	...
	shhf : false,
      ...
      rules: {
          ...
          shenlingshuliang: [
                { required: true, message: '申领数量不能为空', trigger: 'blur' },
                { validator: validateIntNumber, trigger: 'blur' },
          ],
          shenlingshuoming: [
          ],
  ...
  created() {
	this.ruleForm.shenlingriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='shenlingdanhao'){
            this.ruleForm.shenlingdanhao = obj[o];
	    this.ro.shenlingdanhao = true;
            continue;
          }
          if(o=='wuzimingcheng'){
	    ...
	    this.ro.shenlingshuliang = true;
          ...
          if(o=='shenlingshuoming'){
            this.ruleForm.shenlingshuoming = obj[o];
	    this.ro.shenlingshuoming = true;
            continue;
          }
          if(o=='shenlingriqi'){
            this.ruleForm.shenlingriqi = obj[o];
	    this.ro.shenlingriqi = true;
            continue;
          }
          if(o=='yonghuming'){
	...
	if(this.ruleForm.wuzitupian!=null) {
      ...
      if(parseInt(this.ruleForm.shenlingshuliang)>parseInt(this.ruleForm.wuzishuliang)){
        this.$message.error("申领数量不能超过物资数量");
        return
      }

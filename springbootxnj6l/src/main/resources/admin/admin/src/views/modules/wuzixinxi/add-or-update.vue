<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="物资品牌" prop="wuzipinpai">
          <el-input v-model="ruleForm.wuzipinpai" 
              placeholder="物资品牌" clearable  :readonly="ro.wuzipinpai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物资品牌" prop="wuzipinpai">
              <el-input v-model="ruleForm.wuzipinpai" 
                placeholder="物资品牌" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wuzixiangqing" label="物资详情" prop="wuzixiangqing">
                    <span>{{ruleForm.wuzixiangqing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wuziguige = true;
          ...
          if(o=='wuzipinpai'){
            this.ruleForm.wuzipinpai = obj[o];
	    this.ro.wuzipinpai = true;
            continue;
          }
          if(o=='wuzishuliang'){
